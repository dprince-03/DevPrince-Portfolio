...
export default async function DashboardLayout({ children }) {
  ...
  return (
    <div className="min-h-screen">
      <header className="flex items-center justify-between border-b border-term-border bg-term-panel/80 px-6 py-4 backdrop-blur-md">
      ...
      <div className="mx-auto flex max-w-6xl flex-col gap-6 px-6 py-8 sm:flex-row sm:py-10">
        <DashboardNav />
